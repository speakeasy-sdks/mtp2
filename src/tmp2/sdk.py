...
class Tmp2:
    ...
    def add_property(self, request: operations.AddPropertyRequest) -> operations.AddPropertyResponse:
        ...
        res = operations.AddPropertyResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def create_node(self, request: operations.CreateNodeRequest) -> operations.CreateNodeResponse:
        ...
        res = operations.CreateNodeResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_subtree(self, request: operations.GetSubtreeRequest) -> operations.GetSubtreeResponse:
        ...
        res = operations.GetSubtreeResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
